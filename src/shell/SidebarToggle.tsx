 ...
 * brightens to accent. Clicking it expands/collapses the sidebar between its
 * labelled and icon-only layouts. There's deliberately no ⌘B: that's bold in notes.
 */
