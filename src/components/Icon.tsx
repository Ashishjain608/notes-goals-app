...
const paths: Record<IconName, JSX.Element> = {
  ...
  // A six-tooth cog, deliberately unlike the spoked `sun` it sits beside in the nav rail.
  settings: (
    <>
      <path
        d="M10.13 5.88L10.4 2.94A9.2 9.2 0 0 1 13.6 2.94L13.87 5.88A6.4 6.4 0 0 1 16.36 7.32L19.05 6.09A9.2 9.2 0 0 1 20.65 8.85L18.24 10.56A6.4 6.4 0 0 1 18.24 13.44L20.65 15.15A9.2 9.2 0 0 1 19.05 17.91L16.36 16.68A6.4 6.4 0 0 1 13.87 18.12L13.6 21.06A9.2 9.2 0 0 1 10.4 21.06L10.13 18.12A6.4 6.4 0 0 1 7.64 16.68L4.95 17.91A9.2 9.2 0 0 1 3.35 15.15L5.76 13.44A6.4 6.4 0 0 1 5.76 10.56L3.35 8.85A9.2 9.2 0 0 1 4.95 6.09L7.64 7.32A6.4 6.4 0 0 1 10.13 5.88Z"
        {...stroke}
      />
